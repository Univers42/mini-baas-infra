...
help:
	@echo "mini-baas-infra QA & CI/CD Orchestrator"
	@echo ""
	@echo "================== PHASE 1: Native Hooks Foundation =================="
	@echo "  make install-hooks          Register git config and make hooks executable"
	@echo ""
	@echo "================== PHASE 2: Pre-Commit Guard (Auto) =================="
	@echo "  Runs on: git commit"
	@echo "  Checks:"
	@echo "    • Merge conflict markers detection"
	@echo "    • File size validation (500KB max)"
	@echo "    • YAML syntax validation (yamllint, optional)"
	@echo "    • Secret leak detection (gitleaks, optional)"
	@echo ""
	@echo "================== PHASE 3: Pre-Push Guard (Auto) ==================="
	@echo "  Runs on: git push (protected branches: main, develop)"
	@echo "  Checks:"
	@echo "    • Shell script linting (shellcheck)"
	@echo "    • Kubernetes manifest validation (kustomize)"
	@echo ""
	@echo "================== PHASE 4: Manual QA Orchestrator =================="
	@echo "  make lint-yaml              Lint YAML files (deployments, platform)"
	@echo "  make lint-scripts           Lint shell scripts (scripts/)"
	@echo "  make validate-k8s           Validate Kubernetes manifests"
	@echo "  make qa-all                 Run all QA checks sequentially"
	@echo ""
